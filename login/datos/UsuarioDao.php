...
class UsuarioDao extends Conexion
{
    ...
    {
        $query = "SELECT id,nombre,email,usuario,privilegio,fecha_registro, telefono, direccion FROM usuarios WHERE usuario = :usuario AND password = :password";
    ...
    {
        $query = "INSERT INTO usuarios (nombre,email,usuario,password,privilegio, telefono, direccion) VALUES (:nombre,:email,:usuario,:password,:privilegio, :telefono,:direccion)";
