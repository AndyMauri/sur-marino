    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="frminsertu" onsubmit="return actualizarDatos()" method="post">
              ...
              <label>Imagen</label>
              <input type="text" id="imagenu" name="imagenu" class="form-control form-control-sm" required="">
              <label>Descripcion</label>
              <input type="text" id="descripcionu" name="descripcionu" class="form-control form-control-sm" required="">
              <label>Inventariou</label>
              <input type="text" id="inventariou" name="inventariou" class="form-control form-control-sm" required="">
              <label>Precio</label>
