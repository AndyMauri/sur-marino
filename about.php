...
<html lang="es">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
     <!-- Funcionalidad: Inclusión de fuentes y estilos externos -->
  ...
  <div class="site-wrap">
    <!-- Funcionalidad: Inclusión de la barra de navegación -->
    <?php include("./layouts/header.php"); ?> 
    <!-- Funcionalidad: Sección de introducción con imagen y texto -->
    ...
    <!-- Funcionalidad: Sección del equipo -->
    <div class="site-section border-bottom" data-aos="fade">
      <div class="container">
        ...
        <div class="row">
          <!-- Funcionalidad: Miembro del equipo 1 -->
          ...
          <!-- Funcionalidad: Miembro del equipo 2 -->
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
               <!-- Contenido del bloque -->
              <div class="block-38-img">
          ...
          <!-- Funcionalidad: Miembro del equipo 3 -->
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
               <!-- Contenido del bloque -->
              <div class="block-38-img">
           ...
           <!-- Funcionalidad: Miembro del equipo 4 -->
          <div class="col-md-6 col-lg-3">
            <div class="block-38 text-center">
               <!-- Contenido del bloque -->
              <div class="block-38-img">
  ...
  <!-- Inclusión de los scripts de JavaScript -->
